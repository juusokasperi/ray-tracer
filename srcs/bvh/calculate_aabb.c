...
static t_aabb_bounds	calculate_aabb_plane(t_plane plane)
{
	float			limit;
	float			thickness;
	t_aabb_bounds	bounds;
...
static t_aabb_bounds	calculate_aabb_cylinder(t_cylinder cyl)
{
	t_vector		p_1;
	t_vector		p_2;
	t_aabb_bounds	bounds;
...
static t_aabb_bounds	calculate_aabb_cone(t_cone cone)
{
	t_vector		base;
	t_vector		tip;
	t_aabb_bounds	bounds;
